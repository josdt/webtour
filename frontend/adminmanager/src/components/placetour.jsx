            ...
            <div className="d-flex flex-column" id="content-wrapper">
                ...
                <div className="container-fluid"><button className="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i className="fas fa-bars" /></button>
                    ...
                    <div className="container-fluid">
                        <h3 className="text-dark mb-4">Quản lý danh mục Địa danh tour</h3>
                        <form className="form-row" onSubmit={submitCreatePlaceTour}>
                            ...
                            <div className="form-group col-md-6">
                                <label className="col-md-3" htmlFor="formGroupExampleInput"><strong>Địa danh:</strong></label>
                                <select className="col-md-6 form-control form-control-sm custom-select custom-select-sm" required name='idPlace' value={placetour.idPlace} onChange={handleDataPlaceTour}>
                                    <option disabled value={''} >Chọn địa danh...</option>
                                    {places.map(place =>
                ...
                : null
                        ...
                        <div className="card shadow">
                            <div className="card-header py-3">
                                <p className="text-primary m-0 font-weight-bold">Thông tin địa danh tour</p>
                            </div>
                            <div className="card-body">
                                <form onSubmit={submitGetPlaceTour} id="dataTable_length" className="form-row">
                                    <label className="col-md-2"><strong>Chọn tour</strong></label>
                                    ...
                                    <table className="table my-0" id="dataTable">
                                        ...
                                        <tbody>
                                            {placetours.map(placetour =>
                                                <tr>
                                                    ...
                                                    <td><button class="btn btn-danger" disabled={checkrole(sessionStorage.getItem("role"))} onClick={() => submitDelete(placetour.idTour, placetour.idPlace)} >Xoá</button></td>
                                                </tr>
                                            )}
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th><strong>Mã địa danh</strong></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
