...
const Booking = () => {
    ...
    const submitGetBooking = (e) => {
        e.preventDefault();
        axios.get(urlbooking + '/tour/' + idTour)
            .then(response => {
    ...
    const submitDelete = (idcus, idtour) => {
        axios.delete(urlbooking + idcus + '/' + idtour, { headers: { 'id': sessionStorage.getItem("idEmp") } })
            .then((response) => {
            ...
            <div className="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    ...
                    <div className="container-fluid">
                        <h3 className="text-dark mb-4">Quản lý danh mục đặt tour</h3>
                        <div className="card shadow">
                            <div className="card-header py-3">
                                <p className="text-primary m-0 font-weight-bold">Thông tin đặt tour</p>
                            </div>
                            {
                                error.length > 0 ?
                            ...
                            <div className="card-body">
                                <form onSubmit={submitGetBooking} id="dataTable_length" className="form-row">
                                        ...
                                        <tbody>
                                            {bookings.map(booking =>
                                                <tr key={booking.id}>
                                                    ...
                                                    <td>{booking.judge}</td>
                                                    <td><button class="btn btn-danger" disabled={checkrole(sessionStorage.getItem("role"))} onClick={() => submitDelete(booking.idCustomer, booking.idTour)} >Xoá</button></td>
                                                </tr>
                                            )}
