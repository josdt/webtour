...
const Profile = () => {
    ...
    const url = "http://localhost:8080/travel/employee/"
    const [employee, setEmployee] = useState([])

    const { idEmp } = useParams()

    useEffect(() => {
        const fetchData = fetch(url + idEmp)
                                            ...
                                            <div className="card-body">
                                                <form>
                                                    <div className="form-row">
                                                        <div className="col">
                                                            <div className="form-group"><label htmlFor="username"><strong>Tên</strong></label><input className="form-control" type="text" id="username" placeholder={employee.name} /></div>
                                                        </div>
                                                        <div className="col">
                                                            <div className="form-group"><label htmlFor="email"><strong>Địa chỉ</strong></label><input className="form-control" type="email" id="email" placeholder={employee.address} /></div>
                                                        </div>
                                                    </div>
                                                    <div className="form-row">
                                                        <div className="col">
                                                            <div className="form-group"><label htmlFor="first_name"><strong>Email</strong></label><input className="form-control" type="text" id="first_name" placeholder={employee.email} /></div>
                                                        </div>
                                                        <div className="col">
                                                            <div className="form-group"><label htmlFor="last_name"><strong>Điện thoại</strong></label><input className="form-control" type="text" id="last_name" placeholder={employee.phone} /></div>
                                                        </div>
                                                    </div>
