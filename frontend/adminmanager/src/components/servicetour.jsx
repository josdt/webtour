            ...
            <div className="d-flex flex-column" id="content-wrapper">
                ...
                <div className="container-fluid"><button className="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i className="fas fa-bars" /></button>
                    ...
                    <div className="container-fluid">
                        <h3 className="text-dark mb-4">Quản lý danh mục dịch vụ tour</h3>
                        <form className="form-row" onSubmit={submitCreateServiceTour}>
                            ...
                            <div className="form-group col-md-6">
                                <label className="col-md-3" htmlFor="formGroupExampleInput"><strong>Dịch vụ:</strong></label>
                ...
                : null
                        ...
                        <div className="card shadow">
                            <div className="card-header py-3">
                                <p className="text-primary m-0 font-weight-bold">Thông tin dịch vụ tour</p>
                            </div>
                                    ...
                                    <table className="table my-0" id="dataTable">
                                        ...
                                        <tbody>
                                            {servicetours.map(servicetour =>
                                                <tr key={servicetour.id}>
                                                    ...
                                                    <td><button class="btn btn-danger" disabled={checkrole(sessionStorage.getItem("role"))} onClick={() => submitDelete(servicetour.idTour, servicetour.idService)} >Xoá</button></td>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th><strong>Mã dịch vụ</strong></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
